...
namespace RealmRaiders.Core
{
    public static class InfernalRealmBootstrap
    {
        ...
        static void Build()
        {
            ...
            var houndOne = PrototypeRuntimeFactory.CreateEntity("Hellhound A", new Vector3(-3.5f, .7f, -2), houndStats, new Color(.38f, .07f, .025f), false, Vector3.one * .7f, new[] { PrototypeRuntimeFactory.Ability("Leap", AbilityKind.Melee, 12, 2.4f, 1, .14f, .9f) }, false); var houndTwo = PrototypeRuntimeFactory.CreateEntity("Hellhound B", new Vector3(3.5f, .7f, 3), houndStats, new Color(.48f, .1f, .025f), false, Vector3.one * .7f, new[] { PrototypeRuntimeFactory.Ability("Leap", AbilityKind.Melee, 12, 2.4f, 1, .14f, .9f) }, false);
