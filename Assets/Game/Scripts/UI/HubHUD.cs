...
namespace RealmRaiders.UI
{
    public sealed class HubHUD : MonoBehaviour
    {
        ...
        public string SylvanRaidVariantText => buttons.TryGetValue(SylvanRaidVariantAction, out var variant) ? variant.GetComponentInChildren<Text>().text : string.Empty;
        public string InfernalRaidVariantText => buttons.TryGetValue(InfernalRaidVariantAction, out var variant) ? variant.GetComponentInChildren<Text>().text : string.Empty;
        ...
        void Build()
        {
            ...
            Button(SylvanRaidVariantAction, Vector2.zero, CycleSylvanRaidVariant);
            Button(InfernalRaidVariantAction, Vector2.zero, CycleInfernalRaidVariant);
            Button("START SYLVAN JOURNEY", new Vector2(0, 820), StartJourney);
            Button("BUILD SYLVAN", new Vector2(0, 630), () => SelectAndLoad("Sylvan", "RealmBuild")); Button("DEFEND SYLVAN", new Vector2(0, 505), () => SelectAndLoad("Sylvan", "DefenderTest")); Button("RAID SYLVAN", new Vector2(0, 380), () => SelectAndLoad("Sylvan", "SylvanRealm")); Button("RAID INFERNAL — ENT", new Vector2(0, 305), () => SelectAndLoad("Infernal", "InfernalRaid")); Button("DEFEND INFERNAL", new Vector2(0, 255), () => SelectAndLoad("Infernal", "InfernalRealm")); Button("CHARACTER SANDBOX", new Vector2(0, 130), () => CancelAndLoad("CharacterSandbox"));
        ...
        public const string SylvanRaidVariantAction = "NEXT SYLVAN RAID";
        public const string InfernalRaidVariantAction = "NEXT INFERNAL RAID";
        public static string SylvanRaidVariantCopy(string displayName) => $"NEXT SYLVAN RAID: {displayName.ToUpperInvariant()} — TAP TO CHANGE";
        public static string InfernalRaidVariantCopy(string displayName, string tacticalSummary)
            => $"NEXT INFERNAL RAID: {displayName.ToUpperInvariant()}\n{tacticalSummary} — TAP TO CHANGE";
        public static string DestinationForButton(string buttonName) => buttonName switch
        {
            ...
            "RAID SYLVAN" => "SylvanRealm", "RAID INFERNAL — ENT" => "InfernalRaid", "DEFEND INFERNAL" => "InfernalRealm", "CHARACTER SANDBOX" => "CharacterSandbox", _ => null
        };
        ...
        void ApplyHubLayout(PrototypeOrientation orientation)
        {
            ...
            var ys = orientation == PrototypeOrientation.Landscape ? new[] { -55f, -135f, -185f, -230f, -280f, -330f, -390f, -440f, -505f, -590f } : new[] { -150f, -260f, -340f, -395f, -465f, -515f, -665f, -725f, -920f, -1000f };
            var anchor = .25f;
        ...
        void ApplyButtonLayout(PrototypeOrientation orientation)
        {
            ...
            if (orientation == PrototypeOrientation.Landscape)
            {
                ...
                Place(SylvanRaidVariantAction, new Vector2(-470, 476), new Vector2(430, 56)); Place(InfernalRaidVariantAction, new Vector2(-20, 476), new Vector2(430, 56)); Place("START SYLVAN JOURNEY", new Vector2(-20, 398), new Vector2(430, 70)); Place("BUILD SYLVAN", new Vector2(-20, 336), new Vector2(430, 54)); Place("DEFEND SYLVAN", new Vector2(-20, 274), new Vector2(430, 54));
                Place("RAID SYLVAN", new Vector2(-20, 212), new Vector2(430, 54)); Place("RAID INFERNAL — ENT", new Vector2(-20, 150), new Vector2(430, 54)); Place("DEFEND INFERNAL", new Vector2(-20, 88), new Vector2(430, 54)); Place("CHARACTER SANDBOX", new Vector2(-20, 26), new Vector2(430, 54));
            ...
            Place(SylvanRaidVariantAction, new Vector2(0, 845), new Vector2(360, 70), portraitColumn, Vector2.zero); Place(InfernalRaidVariantAction, new Vector2(0, 763), new Vector2(360, 70), portraitColumn, Vector2.zero);
            Place("START SYLVAN JOURNEY", new Vector2(0, 651), new Vector2(360, 100), portraitColumn, Vector2.zero); Place("BUILD SYLVAN", new Vector2(0, 549), new Vector2(360, 90), portraitColumn, Vector2.zero);
            Place("DEFEND SYLVAN", new Vector2(0, 447), new Vector2(360, 90), portraitColumn, Vector2.zero); Place("RAID SYLVAN", new Vector2(0, 345), new Vector2(360, 90), portraitColumn, Vector2.zero);
            Place("RAID INFERNAL — ENT", new Vector2(0, 243), new Vector2(360, 90), portraitColumn, Vector2.zero); Place("DEFEND INFERNAL", new Vector2(0, 141), new Vector2(360, 90), portraitColumn, Vector2.zero); Place("CHARACTER SANDBOX", new Vector2(0, 39), new Vector2(360, 90), portraitColumn, Vector2.zero);
        ...
        void CycleSylvanRaidVariant() { SylvanRaidCompositionSelection.Cycle(); Refresh(); }
        void CycleInfernalRaidVariant() { InfernalRaidCompositionSelection.Cycle(); Refresh(); }
        void Refresh()
        {
            ...
            if (buttons.TryGetValue(SylvanRaidVariantAction, out var variant))
                variant.GetComponentInChildren<Text>().text = SylvanRaidVariantCopy(SylvanRaidCompositionSelection.DisplayName);
            if (buttons.TryGetValue(InfernalRaidVariantAction, out variant))
                variant.GetComponentInChildren<Text>().text = InfernalRaidVariantCopy(InfernalRaidCompositionSelection.DisplayName, InfernalRaidCompositionSelection.TacticalSummary);
        }
