...
namespace RealmRaiders.UI
{
    public sealed class BuildHUD : MonoBehaviour
    {
        ...
        Button[] slots = Array.Empty<Button>(); Button saveButton; Text budget; Text reason; DefenseLayout layout; ResponsiveHudRoot responsive; HudPresentation presentation;
