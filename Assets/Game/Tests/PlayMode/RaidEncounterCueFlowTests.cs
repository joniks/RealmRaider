...
namespace RealmRaiders.Tests
{
    public sealed class RaidEncounterCueFlowTests
    {
        ...
        {
            var expectedSize = orientation == PrototypeOrientation.Portrait ? new Vector2(760, 72) : new Vector2(620, 64);
            var expectedPosition = orientation == PrototypeOrientation.Portrait ? new Vector2(0, -285) : new Vector2(0, -290);
